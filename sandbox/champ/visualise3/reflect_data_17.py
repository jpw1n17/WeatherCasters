...
slt_output_col = 5 # select output w1 (column 6, index=5)
...
spr = create_model(xtr,ytr_sel,0.2)

#======Prediction
yhts_sel = clf.predict(xts)
yhts_sel_2 = spr.predict(xts)
...
yhts_sel_2 = pd.DataFrame(yhts_sel_2)
...
# Hide these grid behind plot objects
ax.set_axisbelow(True)
ax.set_title('LighGBM results coloured by actual output value')
...
# =============================================================================
#  Plot the graph Sparse regression
# =============================================================================

plt.figure(9)
fig, ax = plt.subplots(figsize=(10, 6))
plt.scatter(yts_sel, yhts_sel_2
            , c=colors, alpha=0.5)
plt.plot(ttt, ttt, color='green')
...
# Hide these grid behind plot objects
ax.set_axisbelow(True)
ax.set_title('Regression results coloured by actual output value')
ax.set_xlabel('actual output')
ax.set_ylabel('predicted output')
