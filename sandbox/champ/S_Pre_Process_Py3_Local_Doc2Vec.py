...
#file_path_2 = r'C:\Users\audeb\Southampton Uni\Sem2\Data Mining\Group CW\GitHub\WeatherCasters\data/train.csv'
...
numpy.savetxt('np.csv', docvecs, delimiter=',', header='a,#2')
